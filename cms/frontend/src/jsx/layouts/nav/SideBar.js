...
const SideBar = () => {
	...
	/// Active menu
	let deshBoard = ['', 'dashboard-dark', 'guest-list', 'guest-detail', 'concierge', 'room-list', 'reviews', 'task'],
		app = [
			'section-landing',
			'app-profile',
			'post-details',
			...
			<PerfectScrollbar className="deznav-scroll">
				<MM className="metismenu" id="menu">
					<li className={`${deshBoard.includes(path) ? 'mm-active' : ''}`}>
						...
						<ul>
							<li>
								<Link className={`${path === '' ? 'mm-active' : 'dashboard'}`} to="/dashboard">
									{' '}
									Dashboard Light
								</Link>
							</li>
							...
							<li>
								<Link className={`${path === 'concierge' ? 'mm-active' : ''}`} to="/concierge">
									Concierge
								</Link>
							</li>
							<li>
								<Link className={`${path === 'room-list' ? 'mm-active' : ''}`} to="/room-list">
									Room
								</Link>
							</li>
							<li>
								<Link className={`${path === 'reviews' ? 'mm-active' : ''}`} to="/reviews">
									Reviews
								</Link>
							</li>
							<li>
								<Link className={`${path === 'task' ? 'mm-active' : ''}`} to="/task">
									Task
								</Link>
							</li>
						</ul>
					...
					<li className={`${bootstrap.includes(path) ? 'mm-active' : ''}`}>
						...
						<ul>
							...
							<li>
								<Link className={`${path === 'ui-alert' ? 'mm-active' : ''}`} to="/ui-alert">
									Alert
								</Link>
							</li>
							<li>
								<Link className={`${path === 'ui-badge' ? 'mm-active' : ''}`} to="/ui-badge">
									Badge
								</Link>
							</li>
							<li>
								<Link className={`${path === 'ui-button' ? 'mm-active' : ''}`} to="/ui-button">
									Button
								</Link>
							</li>
							<li>
								<Link className={`${path === 'ui-modal' ? 'mm-active' : ''}`} to="/ui-modal">
									Modal
								</Link>
							</li>
							<li>
							...
							<li>
								<Link className={`${path === 'ui-card' ? 'mm-active' : ''}`} to="/ui-card">
									Cards
								</Link>
							</li>
							<li>
							...
							<li>
								<Link className={`${path === 'ui-tab' ? 'mm-active' : ''}`} to="/ui-tab">
									Tab
								</Link>
							</li>
							<li>
							...
							<li>
								<Link className={`${path === 'ui-grid' ? 'mm-active' : ''}`} to="/ui-grid">
									Grid
								</Link>
							</li>
						</ul>
					...
					<li className={`${plugins.includes(path) ? 'mm-active' : ''}`}>
						...
						<ul>
							...
							<li>
								<Link className={`${path === 'uc-toastr' ? 'mm-active' : ''}`} to="/uc-toastr">
									Toastr
								</Link>
							</li>
							<li>
					...
					<li className={`${redux.includes(path) ? 'mm-active' : ''}`}>
						...
						<ul>
							<li>
								<Link className={`${path === 'todo' ? 'mm-active' : ''}`} to="/todo">
									Todo
								</Link>
							</li>
							<li>
